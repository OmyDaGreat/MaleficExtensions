...
/**
 * JVM implementation of ConcurrentHashMap that delegates to java.util.concurrent.ConcurrentHashMap.
 * This provides true thread-safe concurrent access with high performance on the JVM platform.
 *
